...
| [day 12](https://adventofcode.com/2021/day/12) | [`  0.308ms`](./day12a/src/main.rs) | [`  7.50 ms`](./day12b/src/main.rs) |

|              | one-by-one (1 CPU core)                  | parallel                                    |
|:-------------|:-----------------------------------------|:--------------------------------------------|
| _everything_ | [` 8.785ms`](./runner/src/bin/runner.rs) | [`8.13ms`](./runner/src/bin/runner-par.rs)  |
