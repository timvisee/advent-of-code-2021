...
| [day 8](https://adventofcode.com/2021/day/8)   | [`  0.008ms`](./day08a/src/main.rs) | [`  0.047ms`](./day08b/src/main.rs) |

|              | one-by-one (1 CPU core)                 | parallel                               |
|:-------------|:----------------------------------------|:---------------------------------------|
| _everything_ | [`0.778ms`](./runner/src/bin/runner.rs) | [`?`](./runner/src/bin/runner-par.rs)  |
