...
| [day 16](https://adventofcode.com/2021/day/16) | [`  0.037ms`](./day16a/src/main.rs) | [`  0.044ms`](./day16b/src/main.rs) |

|              | one-by-one (1 CPU core)                  | parallel                                     |
|:-------------|:-----------------------------------------|:---------------------------------------------|
| _everything_ | [`40.08 ms`](./runner/src/bin/runner.rs) | [`39.37ms`](./runner/src/bin/runner-par.rs)  |
