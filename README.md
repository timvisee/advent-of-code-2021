...
| [day 12](https://adventofcode.com/2021/day/12) | [`  0.163ms`](./day12a/src/main.rs) | [`  3.62 ms`](./day12b/src/main.rs) |

|              | one-by-one (1 CPU core)                  | parallel                                    |
|:-------------|:-----------------------------------------|:--------------------------------------------|
| _everything_ | [` 4.652ms`](./runner/src/bin/runner.rs) | [`8.13ms`](./runner/src/bin/runner-par.rs)  |
